    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-10 border border-1">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href="https://www.its.ac.id" class="btn btn-danger">bahaya!</a>
                        <button class="border border-1">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24"
                                height="24"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                <path
